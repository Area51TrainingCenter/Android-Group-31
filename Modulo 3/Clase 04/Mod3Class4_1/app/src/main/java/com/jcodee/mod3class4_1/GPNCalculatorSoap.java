...
public class GPNCalculatorSoap
{
    ...
    public GPNCalculatorSoap(){}

    public GPNCalculatorSoap(String url)
    {
        this.url = url;
    }

    public GPNCalculatorSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GPNExtendedSoapSerializationEnvelope envelope= new GPNExtendedSoapSerializationEnvelope(GPNExtendedSoapSerializationEnvelope.VER11);
        return envelope;
    }
